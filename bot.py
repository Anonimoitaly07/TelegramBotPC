                ...
                for mount_point in ['/media', '/mnt']:
                    if os.path.exists(mount_point):
                        for device in os.listdir(mount_point):
                            devices.add(os.path.join(mount_point, device))
    ...
    def check_devices(self):
        ...
        if new_devices:
            ...
            for device in new_devices:
                message += f"• {device}\n"
            asyncio.create_task(self.bot.send_notification(message))
...
class PCControlBot:
    ...
    def schedule_daily_report(self):
        ...
        schedule.every().day.at("00:00").do(lambda: asyncio.create_task(self.send_daily_report()))
    ...
    def run_schedule(self):
        ...
        while True:
            ...
            self.usb_monitor.check_devices()
            time.sleep(5)
    ...
    async def run_bot(self):
        ...
        try:
            ...
            # Add message handlers for different contexts
            ...
            if platform.system() != "Windows":  # Linux/Mac
                self.observer.schedule(self.usb_monitor, "/media", recursive=False)
                self.observer.start()
